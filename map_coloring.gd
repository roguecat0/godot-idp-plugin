...
func _ready() -> void:
	...
	var border_data = [["Belguim", "France"], ["Belguim", "Germany"], ["Germany", "France"]]
	...
	# var each_bordering_germany = ForEach.create("c", country, country_bordering_germany.implies(counrty_color_is_green))
